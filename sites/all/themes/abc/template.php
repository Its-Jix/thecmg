...
// Set grids responsive stylesheets
  ...
  if(theme_get_setting('css_zone')) {
    ...
    drupal_add_css(drupal_get_path('theme','abc').'/css/yui/'.get_css_version().'/pure-min.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => -2));
  }
  if(theme_get_setting('grid_responsive') == '1') {
    if(theme_get_setting('css_zone')) {
      ...
      drupal_add_css(drupal_get_path('theme','abc').'/css/yui/'.get_css_version().'/grids-responsive-old-ie-min.css', array('group' => CSS_THEME, 'browsers' => array('IE' => 'IE 8', '!IE' => FALSE), 'every_page' => TRUE, 'weight' => -1));
      drupal_add_css(drupal_get_path('theme','abc').'/css/yui/'.get_css_version().'/grids-responsive-min.css', array('group' => CSS_THEME, 'browsers' => array('IE' => 'gt IE 8'), 'every_page' => TRUE, 'weight' => -1));
    }
  }
...
//  print '<div class="'.$dvlk.'"><a href="https://www.eucopyright.com/" title="EU Copyright">'.$nt.'eu&#169;</a></div>';
  print '<div class="'.$dvlk.'"><a href="https://www.eucopyright.com/" title="EU Copyright">eu&#169;</a></div>';
}
